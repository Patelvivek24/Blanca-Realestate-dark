...
var FullCalendar = (function (e) {
  ...
  function Go(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return Zo(
          e,
          t.sourceIds ? Dn(t.sourceIds) : $o(e, r),
          i,
          t.isRefetch || !1,
          r,
        );
  ...
  function qo(e, t, n, r) {
    ...
    return (n && (i = Yo(i, n, r)), Object.assign(Object.assign({}, e), i));
  }
  function Yo(e, t, n) {
    return Zo(
      e,
  ...
  class ua {
    constructor(e) {
      ...
      let l = Vo(n.calendarOptions, o, a),
        c = {
      ...
      (ba(c, a) && this.emitter.trigger("loading", !0),
        (this.state = c),
        this.updateData(),
  ...
  class $a {
    constructor(e, t) {
      ...
      let n = (this.hitDragging = new Ga(e, Oi));
      ((n.requireInitial = !1),
      ...
      class extends Mi {
        constructor(e) {
          (super(e),
            ...
            (this.dragging = new La(e.el)),
            (this.dragging.autoScroller.isEnabled = !1));
          let t = (this.hitDragging = new Ga(this.dragging, Ii(e)));
          (t.emitter.on("pointerdown", this.handlePointerDown),
      ...
      class extends Mi {
        constructor(e) {
          ...
          ((r.touchScrollAllowed = !1),
            ...
            (r.autoScroller.isEnabled = n.dragScroll));
          let i = (this.hitDragging = new Ga(this.dragging, Ii(e)));
          (i.emitter.on("pointerdown", this.handlePointerDown),
            i.emitter.on("dragstart", this.handleDragStart),
            i.emitter.on("hitupdate", this.handleHitUpdate),
            i.emitter.on("pointerup", this.handlePointerUp));
  ...
  class ol extends Gn {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r } = e,
        i = pi(r, n.eventTimeFormat || rl, t, !0, e.defaultDisplayEventEnd);
      return p(
        so,
        Object.assign({}, e, {
          elTag: "a",
  ...
  var Rl = Po({
    ...
    views: {
      dayGrid: {
        component: class extends wl {
          constructor() {
            (super(...arguments),
              (this.buildDayTableModel = Gt(Cl)),
              (this.headerRef = { current: null }),
              (this.tableRef = { current: null }));
          }
          render() {
  ...
  class Ml extends Gn {
    render() {
      return this.props.slatMetas.map((e) =>
        p("tr", { key: e.key }, p(Tl, Object.assign({}, e))),
      );
    }
  }
  const Il = an({ week: "short" });
  class Ol extends ls {
    constructor() {
      (super(...arguments),
        (this.allDaySplitter = new xl()),
          ...
          chunks: [
            {
              ...
              rowContent: (e) =>
                p(
                  "tr",
                  { role: "presentation" },
                  this.renderHeaarindeis("day", e.rowSyncHeights[0]),
                ),
            },
            {
              key: "cols",
    ...
    render() {
      ...
      return p(
        So,
        {
          ...
          dateProfile: e.dateProfile,
          todayRange: e.todayRange,
          popoverContent: () => $l(e.hiddenSegs, e),
          defaultGenerator: Wl,
          forceTimed: !0,
        },
        (e) =>
  ...
  function Fl(e, t) {
    ...
    return (o.sort(Vl), [o.map(Gl), o[0][1]]);
  }
  function Vl(e, t) {
    return t[1] - e[1];
  }
  ...
  const Yl = an({ hour: "numeric", minute: "2-digit", meridiem: !1 });
  class Zl extends Gn {
    render() {
      return p(
        oo,
    ...
    renderPositionedFgSegs(e, t, n, r, i, s) {
      let {
        ...
        { segPlacements: b, hiddenGroups: E } = (function (e, t, n, r) {
          ...
          let { segRects: o, hiddenGroups: a } = Ll(i, n, r),
            l = [];
  ...
  class Kl extends Gn {
    constructor() {
      (super(...arguments),
        (this.splitFgEventSegs = Gt(jl)),
        (this.splitBgEventSegs = Gt(jl)),
        (this.splitBusinessHourSegs = Gt(jl)),
        (this.splitNowIndicatorSegs = Gt(jl)),
        (this.splitDateSelectionSegs = Gt(jl)),
        (this.splitEventDrag = Gt(zl)),
        (this.splitEventResize = Gt(zl)),
        (this.rootElRef = { current: null }),
        (this.cellElRefs = new Vs()));
    }
    render() {
  ...
  function oc(e, t, n, r, i) {
    let s = new Date(0),
      ...
      l =
        ...
        (function (e) {
          let t, n, r;
          for (t = sc.length - 1; t >= 0; t -= 1)
            if (((n = ft(sc[t])), (r = bt(n, e)), null !== r && r > 1))
              return n;
          return e;
        })(r),
      c = [];
  ...
  var lc = Po({
    ...
    views: {
      timeGrid: {
        component: class extends Ol {
          constructor() {
            (super(...arguments),
              (this.buildTimeColsModel = Gt(ac)),
              (this.buildSlatMetas = Gt(oc)));
          }
          render() {
            let {
                options: e,
              ...
              u =
                ...
                p(_s, {
                  ...
                  renderIntro: c ? this.renderHeaarindeis : null,
                }),
              h =
                !1 !== e.allDaySlot &&
                ((t) =>
  ...
  const uc = an({ hour: "numeric", minute: "2-digit", meridiem: "short" });
  class hc extends Gn {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r, timeHeaderId: i, eventHeaderId: s, dateHeaderId: o } = e,
        a = n.eventTimeFormat || uc;
      return p(
        so,
        Object.assign({}, e, {
          elTag: "tr",
              ...
              for (let n = 0; n < a.length; n += 1) {
                ...
                if (d) {
                  let a = Wt(t[n]),
                    u = o + "-" + a;
                  (c.push(
                    p(cc, { key: a, cellId: u, dayDate: t[n], todayRange: l }),
                  ),
                    (d = di(d, r.eventOrder)));
                  for (let t of d)
                    c.push(
  ...
  const Sc = an({ year: "numeric", month: "long" }),
    Ac = an({ month: "long" });
  function Dc(e, t) {
    return (
      e ||
    ...
    views: {
      multiMonth: {
        component: class extends ls {
          constructor() {
            (super(...arguments),
              (this.splitDateProfileByMonth = Gt(Ec)),
